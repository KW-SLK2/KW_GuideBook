...
namespace KW_Guidebook_UI
{
    ...
    private string filePath = ""; //엑셀 파일 주소
        ...
        {
            OleDbConnection con = new OleDbConnection(@"PROVIDER=MICROSOFT.ACE.OLEDB.12.0;Data Source='C:\Users\이원빈\Documents\GitHub\KW_GuideBook\KW_GuideBook\비마_연구실.cell'; Extended Properties = 'Excel 12.0; HDR=yes';");
