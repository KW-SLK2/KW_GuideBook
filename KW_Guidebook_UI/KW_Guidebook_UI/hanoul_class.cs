...
namespace KW_Guidebook_UI
{
    public partial class hanoul_class : Form
    {
        ...
        {
            OleDbConnection con = new OleDbConnection(@"PROVIDER=MICROSOFT.ACE.OLEDB.12.0;Data Source='C:\github\KW_GuideBook\KW_information\한울_강의.cell'; Extended Properties = 'Excel 12.0; HDR=yes';");
