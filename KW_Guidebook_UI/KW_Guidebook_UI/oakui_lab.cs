...
namespace KW_Guidebook_UI
{
    public partial class oakui_lab : Form
    {
        ...
        {
            OleDbConnection con = new OleDbConnection(@"PROVIDER=MICROSOFT.ACE.OLEDB.12.0;Data Source='C:\github\KW_GuideBook\KW_information\옥의_연구실.cell'; Extended Properties = 'Excel 12.0; HDR=yes';");
