...
{
    public partial class yeongu_lab : Form
    {
        public yeongu_lab()
        {
        ...
        private void yeongu_lab_Load(object sender, EventArgs e)
        {
            OleDbConnection con = new OleDbConnection(@"PROVIDER=MICROSOFT.ACE.OLEDB.12.0;Data Source='C:\github\KW_GuideBook\KW_information\연구_연구실.cell'; Extended Properties = 'Excel 12.0; HDR=yes';");
