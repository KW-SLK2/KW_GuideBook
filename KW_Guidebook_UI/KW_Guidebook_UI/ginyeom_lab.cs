...
{
    public partial class ginyeom_lab : Form
    {
        public ginyeom_lab()
        {
            InitializeComponent();
        ...
        private void ginyeom_lab_Load(object sender, EventArgs e)
        {
            OleDbConnection con = new OleDbConnection(@"PROVIDER=MICROSOFT.ACE.OLEDB.12.0;Data Source='C:\Users\이원빈\Documents\GitHub\KW_GuideBook\KW_GuideBook\기념관_연구실.cell'; Extended Properties = 'Excel 12.0; HDR=yes';");
