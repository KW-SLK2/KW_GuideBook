...
{
    public partial class nuri_lab : Form
    {
        public nuri_lab()
        {
        ...
        private void nuri_lab_Load(object sender, EventArgs e)
        {
            OleDbConnection con = new OleDbConnection(@"PROVIDER=MICROSOFT.ACE.OLEDB.12.0;Data Source='C:\Users\이원빈\Documents\GitHub\KW_GuideBook\KW_GuideBook\누리_연구실.cell'; Extended Properties = 'Excel 12.0; HDR=yes';");
